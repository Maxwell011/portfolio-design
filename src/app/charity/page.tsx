    ...
    <section>
      <section className="bg-black flex flex-col items-center justify-center text-center px-[100px] py-0">
        ...
        <p className="text-white text-lg font-normal tracking-[0.36px]">
          ...
          charity organization committed to making a positive impact on the
          lives of those in need. Our mission is to bring hope, support, and
          change to communities worldwide. This landing page serves as a gateway
          to our charitable initiatives, events, and opportunities for you to
        ...
        <div>
          <div>
            ...
            <p className="text-white text-lg font-normal tracking-[0.36px]">
              ...
              engage with our product on their smartphones, whether you are on
              the go or relaxing at home.
            </p>
          </div>
          <div>
            <h2>Result</h2>
