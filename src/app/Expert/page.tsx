          ...
          <div className="border-b-[#CDAF75] border-b border-solid flex flex-col items-start gap-3 px-12 py-6">
            <div className="flex flex-col items-start gap-3 self-stretch px-12 py-6 border-b-[#CDAF75] border-b border-solid">
              ...
              <p className="text-white text-lg font-normal tracking-[0.36px]">
                ...
                professional solutions for their car problems. This website
                should address user pain points through research and also serve
            ...
            <div>
              ...
              <p className="text-white text-lg font-normal tracking-[0.36px]">
                AutoFixHub is a network of mechanics committed to
                revolutionizing the car repair experience, for car owners. Our
                goal is to offer a expert solution for all your vehicle
                maintenance and repair requirements. Through AutoFixHub you can
                effortlessly connect with certified mechanics receive pricing
                estimates and easily arrange appointments that suit your
                schedule. Every mechanic undergoes a screening process that
                includes background checks, criminal record checks and reference
                checks. Our focus is on empowering car owners with solutions to
                ensure that you have a partner, for all your automotive needs.
              </p>
            </div>
            <div>
              <h2 className="text-white text-[32px] font-semibold tracking-[0.64px]">
