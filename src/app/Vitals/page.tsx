    ...
    <section>
      <section className="bg-black flex flex-col items-center justify-center text-center px-[100px] py-0">
        ...
        <p>
          ...
          privacy, and interoperability in healthcare while empowering patients
        ...
        <p>
          ...
          issues like data fragmentation, limited interoperability, privacy
          concerns, and vulnerabilities to unauthorized access. Centralized EMR
          systems are prone to data breaches and system failures, hindering
          collaboration and compromising patient privacy.
        </p>
        <h2>Our Solutions</h2>
        <p>
        ...
        <h2>Research</h2>
        <p>
          Since there was an already existing ecosystem for EMR software, my
          team and I conducted in-depth interviews with healthcare
          professionals, including doctors, nurses, and administrative staff, to
          understand their daily workflows and pain points when using EMR
          software. We also met various individuals and asked them about their
          experience with their medical record, privacy and possible changes
        ...
        <p>
          ...
          need and it will help us to create products and experiences that truly
          resonate with users. This empathetic approach ensures that design
          solutions are not only functional but also meaningful and enjoyable
          for the people who use them. Ultimately, empathy is the foundation for
